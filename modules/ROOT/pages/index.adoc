...
Welcome to this quick course on the _**DevEx with Developer Hub**_.
This course is the `fourth` in a series of `six` courses about **Application Platform Delivery**:

* https://link[_Application Platform Delivery Foundations_, window=browser]
* https://link[_Software Factory & Developer Experience_, window=browser]
* https://link[_CICD_, window=browser]
* _DevEx with Developer Hub_(_This course_)
