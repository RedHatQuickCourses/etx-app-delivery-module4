...
:navtitle: Lab 1: Install and Configure Red Hat Developer Hub
:experimental:
...
. From the navigation menu, select menu:Ecosystem[Software Catalog].
. Search for *Red Hat Developer Hub*.
+
WARNING: Select the **Operator Backed** entry. Do **not** select the Helm chart.
+
. Click btn:[Install].
...
image::rhdh-operator.png[link={imagesdir}/rhdh-operator.png,width=600]
...
. Select *Guest* and click btn:[Enter].
...
.Home Page (_Click the image to view it in full size in a new browser tab_)
